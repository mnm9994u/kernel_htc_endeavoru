...
static struct snd_soc_card snd_soc_tegra_aic3008 = {
	...
	.suspend_pre = (int (*)(struct snd_soc_card *))tegra_suspend_pre,
	.suspend_post = (int (*)(struct snd_soc_card *))tegra_suspend_post,
	.resume_pre = (int (*)(struct snd_soc_card *))tegra_resume_pre,
	.resume_post = (int (*)(struct snd_soc_card *))tegra_resume_post,
};
